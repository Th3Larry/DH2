export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	bulbasaur: {
		...
		baseStats: {hp: 55, atk: 50, def: 50, spa: 65, spd: 65, spe: 45},
	...
	ivysaur: {
		...
		types: ["Grass", "Normal"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 65, atk: 65, def: 70, spa: 85, spd: 85, spe: 60},
		abilities: {0: "Overgrow", H: "Chlorophyll"},
		heightm: 1,
		weightkg: 13,
		color: "Green",
	...
	venusaur: {
		...
		types: ["Grass", "Normal"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 85, atk: 80, def: 85, spa: 100, spd: 100, spe: 80},
		abilities: {0: "Overgrow", H: "Chlorophyll"},
		heightm: 2,
		weightkg: 100,
		color: "Green",
